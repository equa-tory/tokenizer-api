...
app.include_router(admin_logs.router, prefix="/logs", tags=["_admin"])
app.include_router(admin_backup.router, prefix="/backup", tags=["_admin"])
app.include_router(admin_setttings.router, prefix="/settings", tags=["_admin"])

app.include_router(user_types.router, prefix="/ticket/types", tags=["_user"])
app.include_router(user_book.router, prefix="/ticket/book", tags=["_user"])
app.include_router(user_cancel.router, prefix="/ticket/cancel", tags=["_user"])
app.include_router(user_slots.router, prefix="/timeslots", tags=["_user"])
app.include_router(user_status.router, prefix="/status", tags=["_user"])
